...
export type CloseInput<
  ...
  TAccountIswap extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountIswap>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountIswap> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.iswap),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountIswap>;
